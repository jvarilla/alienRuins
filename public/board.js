...
//    board.ruins.length --> How many Ruins Are There
...
function GameBoard()
{
 ...
 this.ruins = [

  {
    ...
    size: 5,
    successes: 0,
		displayImg: "palace.png",
		primaryColor: "#283593",//blue,
...

  {
    ...
    size: 4,
    successes: 0,
		displayImg: "temple.png",
		primaryColor: "#B71C1C",//red
...

  {
    ...
    size: 4,
    successes: 0,
		displayImg: "forum.png",
		primaryColor: "#AFB42B",//"#827717"//Dark Gold//"#F9A825"
...

  {
    ...
    size: 3,
    successes: 0,
		displayImg: "house.png",
		primaryColor: "#8E24AA",//fushia
    secondaryColor: "#E040FB"//fushia
  },
  ...
  this.cellMarker = '<img src="sand2.png"/>'; //"X';
}
